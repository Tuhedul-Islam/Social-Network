...
<div class="col-lg-6">
				<div class="central-meta">
					<ul class="photos">
						...
						<li>
							<a class="strip" href="images/resources/photo-66.jpg" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
								<img src="<?php echo e(asset('public/frontend/images/resources/photo13.jpg')); ?>" alt=""></a>
						</li>
					</ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Mproject\social-network\resources\views/frontend/page/photospage.blade.php ENDPATH**/ ?>