                    ...
                    <tr>
                        ...
                        <td colspan="<?php echo count($all_activity); ?>">
                            <div class="checkbox checkbox-success">
                                ...
                                <label for="activity_header" style="font-weight: bold;margin-bottom:15px;"><?php echo trans('english.UPDATE_EXIST_USERS'); ?></label>
                            </div>
                            ...
                            <div class="col-sm-8 col-sm-offset-0">
                                ...
                                <?php //} ?>
                                <a class="btn btn-default" href="<?php echo URL::to('roleacl'); ?>"><?php echo trans('english.CANCEL'); ?></a>
                            </div>
                        </td>
                    </tr>
                    <?php
...
<?php /**PATH C:\xampp\htdocs\social-network\resources\views/acl/roleaclsetup.blade.php ENDPATH**/ ?>