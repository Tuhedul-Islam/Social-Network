            ...
            <div class="hpanel">
                <div class="panel-heading hbuilt">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-info btn-effect-ripple" href="<?php echo URL::to('activity/create'); ?>"><i class="fa fa-plus"></i> Create Activity</a>
                    </div>
                    <?php } ?>
                    <h4>Activity Management</h4>
                </div>
                <div class="panel-body">
                    <?php echo Form::open(array('activity' => 'form', 'url' => 'activity/filter', 'class' => 'form-horizontal')); ?>
                                ...
                                <tr class="contain-center">
                                    ...
                                    <td class="action-center">
                                        <div class="text-center">
                                            <?php echo Form::open(array('url' => 'activity/' . $value->id)); ?>
                                            ...
                                            <a class="btn btn-primary btn-xs" href="<?php echo URL::to('activity/' . $value->id . '/edit'); ?>">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\social-network\resources\views/activity/index.blade.php ENDPATH**/ ?>