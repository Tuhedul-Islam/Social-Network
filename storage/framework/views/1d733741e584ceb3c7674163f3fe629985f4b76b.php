									...
									<div class="editing-info">
										...
										<form method="post" action="<?php echo e(route('profile.store',$user->id)); ?>" enctype="multipart/form-data">
											...
											<div class="form-group half ">
							                 ...
							                 <div class="form-group half ">
							                  <h6>Banner Image</h6>	
							                  <input type="file" name="profile_banner" required="required"/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Mproject\social-network\resources\views/frontend/page/profile.blade.php ENDPATH**/ ?>