...
<aside id="menu">
    <div id="navigation">
        ...
        <ul class="list-group" id="side-menu">
            ...
            <li <?php $current = ($currentControllerName == 'approve-user') ? 'active' : ''; ?> class=" d-flex justify-content-between align-items-center pl-3 <?php echo $current; ?>" >
                <a href="<?php echo URL::to('approve-user'); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.APPROVE_USER')); ?></a>
            ...
            <li <?php $current = ($currentControllerName == 'approve-post') ? 'active' : ''; ?> class=" d-flex justify-content-between align-items-center pl-3 <?php echo $current; ?>" >
                <a href="<?php echo URL::to('approve-post'); ?>" class="text-decoration-none d-block"><?php echo e(__(session()->get('localeVal').'.APPROVE_POST')); ?></a>
    ...
    <?php /**PATH D:\xampp\htdocs\Mproject\social-network\resources\views/includes/mainMenu.blade.php ENDPATH**/ ?>