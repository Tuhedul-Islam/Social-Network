...
<div class="widget friend-list stick-widget">
										...
										<ul id="people-list" class="friendz-list">
											...
											<li>
												<figure>
													<img src="<?php echo e(asset('public/frontend/images/resources/friend-avatar3.jpg')); ?>" alt="">
											...
											<li>
												<figure>
													<img src="<?php echo e(asset('public/frontend/images/resources/friend-avatar4.jpg')); ?>" alt="">
													<span class="status f-off"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="<?php echo e(asset('public/frontend/images/resources/friend-avatar5.jpg')); ?>" alt="">
													<span class="status f-online"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="<?php echo e(asset('public/frontend/images/resources/friend-avatar6.jpg')); ?>" alt="">
													<span class="status f-away"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="<?php echo e(asset('public/frontend/images/resources/friend-avatar7.jpg')); ?>" alt="">
													<span class="status f-off"></span>
												</figure>
												<div class="friendz-meta">
									...
									</div><!-- friends list sidebar --><?php /**PATH D:\xampp\htdocs\Mproject\social-network\resources\views/frontend/rightsidebar.blade.php ENDPATH**/ ?>